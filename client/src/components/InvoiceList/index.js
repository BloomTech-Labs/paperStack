...
import { Modal, ModalHeader, ModalBody, ModalFooter, Card, CardText, CardBody, CardTitle, Button  } from 'reactstrap';
...
class InvoiceList extends Component {
  ...
  handleDelete = () => {
    this.toggleModal();
    axios.delete(`https://lspaperstack.herokuapp.com/invoices`, {
      params: { 
        ...
        <Card key={invoice._id}>
          <CardBody>
            ...
            <div className="Invoice-List-date-wrapper">
              ...
              <CardText>{moment(invoice.createdAt).format('MMMM Do YYYY, h:mm:ss a')}</CardText>
            </div>
          </CardBody>
          <footer>
            <Button className="Invoice-List-edit-btn" onClick={() => { this.handleEdit(invoice._id) }}>Edit</Button>
            <Button className="Invoice-List-delete-btn" onClick={() => { this.openDeleteModal(invoice._id, i) }}>Delete</Button>
          </footer>
        </Card>
        );
      });
  ...
  render() {
    return (
      <div className="Invoice-List"><Navigation />
        <div className="Invoice-List-container">
        <Card className="Invoice-List-add-card" onClick={this.handleCreateNew}>
          <CardBody>
            <Button className="Invoice-List-add-btn"><span>&#43;</span></Button>
