        ...
        <Collapse isOpen={this.state.isOpen} navbar>
          <Nav className="ml-auto" navbar>
            <NavItem active={window.location.pathname === "/new"}>
              <NavLink onClick={() => this.props.history.push("/new")}>
                New
              </NavLink>
            </NavItem>
            <NavItem active={window.location.pathname === "/list"}>
              <NavLink onClick={() => this.props.history.push("/list")}>
                Invoices
              </NavLink>
            </NavItem>
            <NavItem active={window.location.pathname === "/billing"}>
              <NavLink onClick={() => this.props.history.push("/billing")}>
                Billing
              </NavLink>
            </NavItem>
            <NavItem active={window.location.pathname === "/settings"}>
              <NavLink onClick={() => this.props.history.push("/settings")}>
                Settings
              </NavLink>
            </NavItem>
            <NavItem>
